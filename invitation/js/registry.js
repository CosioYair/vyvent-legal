 ...
 */
import weddingRomanticV1 from '../templates/wedding-romantic/template.js?v=20260820b';
import weddingClassicGoldV1 from '../templates/wedding-classic-gold/template.js?v=20260820b';
import weddingBotanicalV1 from '../templates/wedding-botanical/template.js?v=20260820b';
import weddingEditorialV1 from '../templates/wedding-editorial/template.js?v=20260820b';
import weddingCelestialV1 from '../templates/wedding-celestial/template.js?v=20260820b';
import customDesignV1 from '../templates/custom-design/template.js?v=20260820b';
import { CONTRACT_VERSION } from './config.js?v=20260820b';
