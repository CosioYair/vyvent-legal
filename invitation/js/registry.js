 ...
 */
import weddingRomanticV1 from '../templates/wedding-romantic/template.js?v=20260819a';
import weddingClassicGoldV1 from '../templates/wedding-classic-gold/template.js?v=20260819a';
import weddingBotanicalV1 from '../templates/wedding-botanical/template.js?v=20260819a';
import weddingEditorialV1 from '../templates/wedding-editorial/template.js?v=20260819a';
import weddingCelestialV1 from '../templates/wedding-celestial/template.js?v=20260819a';
import customDesignV1 from '../templates/custom-design/template.js?v=20260819a';
import { CONTRACT_VERSION } from './config.js?v=20260819a';
